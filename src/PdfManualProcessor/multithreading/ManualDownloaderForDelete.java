 ...
 *
 */
public class ManualDownloaderForDelete implements Runnable {
    private BlockingQueue<Manual> downloadingQueue;
    private final BlockingQueue<List<Manual>> manualWritingQueue;



    public ManualDownloaderForDelete(BlockingQueue<Manual> downloadingQueue, BlockingQueue<List<Manual>> manualWritingQueue) {
